 ...
 * [afpo.yml](afpo.yml)
     * Determines how your purl.obolibrary.org/obo/afpo/ redirects will be handled
     ...
     * Paste in the contents of [afpo.yml](afpo.yml)
 ...
 * [afpo.md](afpo.md)
     ...
     * Paste in the contents of [afpo.md](afpo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
